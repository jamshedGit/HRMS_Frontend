...
export const compensationBenefitsSlice = createSlice({
    ...
    reducers: {
        ...
        compensationBenefitsDeleted: (state, action) => {
        ...
        compensationBenefitsUpdated: (state, action) => {
            state.error = null;
            state.actionsLoading = false;
            ...
            state.entities = state.entities.map((entity) => {
                ...
                let finalObj = JSON.parse(payloadObj.updateCompensationBenefitsObj);
                if (entity.Id === finalObj.Id) {
                    return finalObj; //action.payload.updatedcompensationBenefits;
                }
                return entity;
            });
