...
export const deductionSlice = createSlice({
    name: "deduction",
    initialState: initialDeductionState,
    reducers: {
        ...
        deductionUpdated: (state, action) => {
            ...
            state.entities = state.entities.map((entity) => {
                ...
                let finalObj = JSON.parse(payloadObj.updatedDeduction);
                if (entity.Id === finalObj.Id) {
                    return finalObj; //action.payload.updateddeduction;
                }
                return entity;
            });
