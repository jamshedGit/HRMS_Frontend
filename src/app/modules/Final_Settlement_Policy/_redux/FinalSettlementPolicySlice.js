...
export const FinalSettlementPolicySlice = createSlice({
    name: "finalSettlementPolicy",
    ...
    reducers: {
        ...
        finalSettlementPolicyFetched: (state, action) => {
            // console.log(action)
         ...
         //get User By ID
         finalSettlementPolicyFetchedForEdit: (state, action) => {
        ...
        finalSettlementPolicyDeleted: (state, action) => {
        ...
        finalSettlementPolicyUpdated: (state, action) => {
            state.error = null;
            state.actionsLoading = false;
            ...
            state.entities = state.entities.map((entity) => {
                ...
                let finalObj = JSON.parse(payloadObj.updatedfinalSettlementPolicy);
                if (entity.Id === finalObj.Id) {
                    return finalObj; //action.payload.updatedfinalSettlementPolicy;
                }
                return entity;
            });
