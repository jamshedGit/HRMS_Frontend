...
import * as actions from "../../../_redux/employeeTypeActions";
import {
...
import * as uiHelpers from "../EmpTypeUIHelpers";
...
export function EmpTypeTable() {
  ...
  const isAccessForEdit = userAccess?.find(
    (item) => item.componentName === "CreateEmployeeType"
  );

  const isAccessForDelete = userAccess?.find(
    (item) => item.componentName === "DeleteEmployeeType"
  );
  // Table columns
  const columns = [
    {
