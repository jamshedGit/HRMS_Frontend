...
export function IncomeTaxOpeningSection({ downloadExcel, dispatch }) {
  ...
  const onClick = (e) => {
    e.preventDefault();
    downloadExcel(document, 'tax_opening_balance', 'Income_Tax_Template')
  }
              ...
              <Card.Header>
                <div className='accordion-header-btn'>
                  <Accordion.Toggle as={Button} eventKey="0">
                    Data Upload - Income Tax Opening Balance
                    <KeyboardArrowDown />
                  </Accordion.Toggle>
                </div>
              </Card.Header>
                    ...
                    <fieldset>
                      ...
                      <div className="from-group row">
                        ...
                        <div className="col-12 col-md-4 mt-3" style={{textAlign:"center", textDecoration: 'underline'}}>
                          <a><span onClick={onClick}>Download -  Income Tax Opening Balance Template</span></a>
                        </div>
