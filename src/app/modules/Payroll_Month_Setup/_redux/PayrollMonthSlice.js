...
export const PayrollMonthSlice = createSlice({
    name: "Payroll Month",
    ...
    reducers: {
       ...
       payrollMonthDeleted: (state, action) => {
       ...
       payrollMonthUpdated: (state, action) => {
            state.error = null;
            state.actionsLoading = false;
            ...
            state.entities = state.entities.map((entity) => {
                ...
                let finalObj = JSON.parse(payloadObj.updatedFiscalSetup);
                if (entity.Id === finalObj.Id) {
                    return finalObj; //action.payload.updatedFiscalSetup;
                }
                return entity;
            });
