...
export const loan_manag_confSetupSlice = createSlice({
    name: "TaxSetup",
    ...
    reducers: {
        ...
        TaxSetupUpdated: (state, action) => {
            ...
            state.entities = state.entities.map((entity) => {
                ...
                let finalObj = JSON.parse(payloadObj.updatedTaxSetup);
                if (entity.Id === finalObj.Id) {
                    return finalObj; //action.payload.updatedTaxSetup;
                }
                return entity;
            });
