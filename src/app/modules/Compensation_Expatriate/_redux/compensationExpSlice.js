...
export const compensationExpSlice = createSlice({
    name: "earnings",
    ...
    reducers: {
        ...
        compensation_exp_Fetched: (state, action) => {
            // 
            
            
            const entities = action.payload.data?.data.rows;
            console.log("ent compensation_exp_",entities)
         ...
         //get User By ID
         compensation_exp_FetchedForEdit: (state, action) => {
        ...
        compensation_exp_Deleted: (state, action) => {
        ...
        compensation_exp_Created: (state, action) => {
             console.log("action payload for compensation_exp_", action.payload);
            state.actionsLoading = false;
            state.error = null;
            state.entities.unshift(action.payload);
        },
        compensation_exp_Updated: (state, action) => {
            state.error = null;
            state.actionsLoading = false;
