...
export function ContactPage({ history }) {
  ...
  const BanksUIEvents = {
    ...
    openDeleteBankDialog: (id, status) => {
      history.push(`/contact/read-all-contact/${id}/${status}/delete`);
    },
    openActiveBankDialog: (id) => {
      history.push(`/contact/read-all-contact/${id}/active`);
    },
    openReadBankDialog: (id, isUserRead) => {
      ...
      // dispatch(fetchCenters());
      // dispatch(fetchUserStatusTypes({ filter: { normal: true } }));
      history.push(`/contact/read-all-contact/${id}/read`);
    },
  };
  return (
    ...
    <BanksUIProvider BanksUIEvents={BanksUIEvents}>
      ...
      <Route path="/contact/read-all-contact/:id/edit">
        {({ history, match }) => (
          <BankEditDialog
            show={match != null}
      ...
      <Route path="/contact/read-all-contact/:id/read">
        {({ history, match }) => (
          <BankEditDialog
            show={match != null}
            id={match && match.params.id}
      ...
      <Route path="/contact/read-all-contact/:id/:status/delete">
        {({ history, match }) => (
          <BankDeleteDialog
            show={match != null}
            id={match && match.params.id}
      ...
      <Route path="/contact/read-all-contact/:id/active">
        {({ history, match }) => (
          <BankActiveDialog
            show={match != null}
            id={match && match.params.id}
