...
import { EmployeeSkillsEditForm } from "./EmployeeSkillsEditForm";
import { EmployeeSkillsEditDialogHeader } from "./EmployeeSkillsEditDialogHeader";
...
export function EmployeeSkillsEditDialog({ id, show, onHide, userForRead }) {
  const [action, setaction] = useState(false);
  const [loading, setLoading] = useState(false);
  const title = "EmployeeSkillsEditDialog";
      ...
      <Accordion defaultActiveKey="">
        <Card>
          ...
          <Accordion.Collapse eventKey="0">
            <Card.Body>
              <EmployeeSkillsEditDialogHeader id={id} isUserForRead={userForRead} />
              <EmployeeSkillsEditForm
                saveForm={saveForm}
