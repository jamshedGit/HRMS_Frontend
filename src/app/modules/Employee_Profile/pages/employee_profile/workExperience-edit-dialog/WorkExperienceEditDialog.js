...
import { WorkExperienceEditDialogHeader } from "./WorkExperienceEditDialogHeader";
...
export function WorkExperienceEditDialog({ id, show, onHide, userForRead }) {
  const [action, setaction] = useState(false);
  const [loading, setLoading] = useState(false);
  const title = "WorkExperienceEditDialog";
      ...
      <Accordion defaultActiveKey="">
        <Card>
          ...
          <Accordion.Collapse eventKey="0">
            <Card.Body>
              <WorkExperienceEditDialogHeader id={id} isUserForRead={userForRead} />
