...
import { IncidentInfoEditForm } from "./IncidentInfoEditForm";
import { IncidentInfoEditDialogHeader } from "./IncidentInfoEditDialogHeader";
...
export function IncidentInfoEditDialog({ id, show, onHide, userForRead }) {
  const [action, setaction] = useState(false);
  const [loading, setLoading] = useState(false);
  const title = "IncidentInfoEditDialog";
      ...
      <Accordion defaultActiveKey="">
        <Card>
          ...
          <Accordion.Collapse eventKey="0">
            <Card.Body>
              <IncidentInfoEditDialogHeader id={id} isUserForRead={userForRead} />
              <IncidentInfoEditForm
                saveForm={saveForm}
