...
import { AcademicInfoEditForm } from "./AcademicInfoEditForm";
import { AcademicInfoEditDialogHeader } from "./AcademicInfoEditDialogHeader";
...
export function AcademicInfoEditDialog({ id, show, onHide, userForRead }) {
  const [action, setaction] = useState(false);
  const [loading, setLoading] = useState(false);
  const title = "AcademicInfoEditDialog";
      ...
      <Accordion defaultActiveKey="">
        <Card>
          ...
          <Accordion.Collapse eventKey="0">
            <Card.Body>
              <AcademicInfoEditDialogHeader id={id} isUserForRead={userForRead} />
