...
import { deleteEarningDeductionTran, deleteEmployee_Salary_Expatriate } from "../../../_redux/bankCrud";
...
export function BankActiveDialog({ id, status, show, onHide }) {
  ...
  const { isLoading } = useSelector(
    (state) => ({ isLoading: state.salary_expatriate.actionsLoading }),
    shallowEqual
  );
    ...
    >
      ...
      <Modal.Footer>
        <div>
          ...
          <button
            type="button"
            onClick={deleteEmployee_Salary_Expatriate}
